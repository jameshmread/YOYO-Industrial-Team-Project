                    ...
                    @else
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu" role="menu">
                                ...
                                <li>
                                    <a href="{{route('store.total')}}">Total sales</a>
                                </li>
                                ...
                                <li>
                                    <a href="{{route('user.volumeperstore')}}">User volume</a>
                                </li>

                                <li>
                                    <a href="{{route('store.retained')}}">User retention</a>
                                </li>

                                <li>
                                    <a href="{{route('store.unique')}}">Unique users</a>
                                </li>
                            </ul>
                        </li>
